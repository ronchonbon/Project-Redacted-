init python:
    ...
    def checkout():
        ...
        for G in active_Girls:
            ...
            G.devotion = 1000 if G.devotion > 1000 else G.devotion
            G.devotion = 0 if G.devotion < 0 else G.devotion

            G.trust = 1000 if G.trust > 1000 else G.trust
            G.trust = 0 if G.trust < 0 else G.trust

            G.desire = 99 if G.desire > 99 else G.desire
            G.desire = 0 if G.desire < 0 else G.desire
