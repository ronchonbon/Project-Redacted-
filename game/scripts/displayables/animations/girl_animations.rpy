...
label show_Girl(Girl, x_position = None, y_position = None, sprite_layer = None, color_transform = None, animation_transform = None, transition = None):
    $ renpy.start_predict(f"images/{Girl.tag}_standing/*.*")

    if Girl == RogueX:
        $ renpy.start_predict(f"images/{Girl.tag}_blowjob/*.*")
    elif Girl == MystiqueX:
    ...
    if color_transform and animation_transform and transition:
        if Girl == RogueX:
            ...
            if Girl.disguise:
                show expression f"Mystique_sprite standing {Girl.disguise}" zorder Girl.sprite_layer as Mystique_sprite at sprite_location(Girl.sprite_location, y_position), color_transform, animation_transform with transition
            else:
        ...
        if Girl == RogueX:
            ...
            if Girl.disguise:
                show expression f"Mystique_sprite standing {Girl.disguise}" zorder Girl.sprite_layer as Mystique_sprite at sprite_location(Girl.sprite_location, y_position), color_transform, animation_transform
            else:
        ...
        if Girl == RogueX:
            ...
            if Girl.disguise:
                show expression f"Mystique_sprite standing {Girl.disguise}" zorder Girl.sprite_layer as Mystique_sprite at sprite_location(Girl.sprite_location, y_position), color_transform with transition
            else:
        ...
        if Girl == RogueX:
            ...
            if Girl.disguise:
                show expression f"Mystique_sprite standing {Girl.disguise}" zorder Girl.sprite_layer as Mystique_sprite at sprite_location(Girl.sprite_location, y_position), animation_transform with transition
            else:
        ...
        if Girl == RogueX:
            ...
            if Girl.disguise:
                show expression f"Mystique_sprite standing {Girl.disguise}" zorder Girl.sprite_layer as Mystique_sprite at sprite_location(Girl.sprite_location, y_position), color_transform
            else:
        ...
        if Girl == RogueX:
            ...
            if Girl.disguise:
                show expression f"Mystique_sprite standing {Girl.disguise}" zorder Girl.sprite_layer as Mystique_sprite at sprite_location(Girl.sprite_location, y_position), animation_transform
            else:
        ...
        if Girl == RogueX:
            ...
            if Girl.disguise:
                show expression f"Mystique_sprite standing {Girl.disguise}" zorder Girl.sprite_layer as Mystique_sprite at sprite_location(Girl.sprite_location, y_position), null with transition
            else:
        ...
        if Girl == RogueX:
            ...
            if Girl.disguise:
                show expression f"Mystique_sprite standing {Girl.disguise}" zorder Girl.sprite_layer as Mystique_sprite at sprite_location(Girl.sprite_location, y_position), null
            else:
...
label hide_Girl(Girl, transition = None):
    ...
    $ renpy.stop_predict(f"images/{Girl.tag}_standing/*.*")
    $ renpy.stop_predict(f"images/{Girl.tag}_handjob/*.*")
    $ renpy.stop_predict(f"images/{Girl.tag}_titjob/*.*")
    $ renpy.stop_predict(f"images/{Girl.tag}_footjob/*.*")
    $ renpy.stop_predict(f"images/{Girl.tag}_blowjob/*.*")
    $ renpy.stop_predict(f"images/{Girl.tag}_sex/*.*")
    $ renpy.stop_predict(f"images/{Girl.tag}_doggy/*.*")
...
label show_handjob(Girl):
    if renpy.showing(f"{Girl.tag}_sprite handjob"):
        return
    ...
    $ renpy.start_predict(f"images/{Girl.tag}_handjob/*.*")
...
label show_titjob(Girl):
    if renpy.showing(f"{Girl.tag}_sprite titjob"):
        return
    ...
    $ renpy.start_predict(f"images/{Girl.tag}_titjob/*.*")
...
label show_blowjob(Girl):
    if renpy.showing(f"{Girl.tag}_sprite blowjob"):
        return
...
label show_sex(Girl):
    ...
    $ renpy.start_predict(f"images/{Girl.tag}_sex/*.*")
...
label show_doggy(Girl):
    if renpy.showing(f"{Girl.tag}_sprite doggy"):
        return
    ...
    $ renpy.start_predict(f"images/{Girl.tag}_doggy/*.*")
