label train:
    ...
    if round >= 80:
        ...
        "You have a short workout in the Danger Room."
    else:
        "You squeeze in a quick session in the Danger Room."
    ...
    if D20 > 16:
        ...
        $ line = renpy.random.choice([
            ...
            "Beast is teaching a class on parkour. You take part and pick up a few pointers. You’re no Spider-Man, but at least you learn a few things.",
