...
label end_of_action_lines(Girl, Action_type):
    if Girl == RogueX:
        ...
        $ lines = [f"Ok, {Girl.player_petname} breaktime.",
            "Ok, I'm kinda done for now, I need a break."]

        if Action_type in passive_Action_types:
            $ lines.append("Ok, I'm taking a quick break. . .")
    elif Girl == JeanX:
        $ lines = [f"Ok, {Girl.player_petname} time for a break.",
...
label ten_rounds_left_lines(Girl, Action_type):
    if Girl == RogueX:
        ...
        $ lines = [f"It's{Girl.Like}getting kinda late.",
...
label auto_rejected_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"Ah, ah, Just keep doing what you were doing, {Girl.player_petname}.",
        ...
        $ lines = [f"Nuh-uh, {Girl.player_petname}, get back to what you were doing.",
        ...
        $ lines = [f"Whoa, back off, {Girl.player_petname}.",
        ...
        $ lines = [f"Roll it back, {Girl.player_petname}. . .",
            f"Whoa, back off, {Girl.player_petname}.",
        ...
        $ lines = [f"Not so fast, {Girl.player_petname}. . .",
        ...
        $ lines = [f"Cool your jets, {Girl.player_petname}. . .",
            f"Whoa, back off, {Girl.player_petname}.",
            f"{Girl.player_petname}! No. . ."]
...
label taboo_lines(Girl, Action_type):
    if Girl == RogueX:
        ...
        $ lines = [f"As I said, not here, {Girl.player_petname}.",
        ...
        $ lines = [f"I told you, not here, {Girl.player_petname}.",
            "I said not in public.",
            "This is just way too exposed!",
        ...
        $ lines = [f"This area is too public, {Girl.player_petname}.",
...
label action_not_done_yet_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"I just don't think I'm ready yet, {Girl.player_petname}. . .",
        ...
        $ lines = [f"I'm{Girl.like}not ready for that, {Girl.player_petname}. . .",
            "Not. . . yet. . . maybe later.",
            f"Not yet, {Girl.player_petname}. . .",
            "I. . . don't think that's. . .",
            f"I'm not really up for that, {Girl.player_petname}. . .",
        ...
        $ lines = [f"Look, I don't know if we're ready for that, {Girl.player_petname}. . .",
        ...
        $ lines = [f"Perhaps some other time, {Girl.player_petname}. . .",
            "Mmm. . . that would. . . no. . .",
...
label sorry_never_mind_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"Ok, no problem, {Girl.player_petname}.",
            f"Yeah, fine, {Girl.player_petname}.",
            f"Yeah, ok, {Girl.player_petname}.",
            "Fine.",
            "No problem."]
    elif Girl == KittyX:
        $ lines = [f"It's cool, {Girl.player_petname}.",
            "No problem.",
            f"Yeah, ok, {Girl.player_petname}.",
        ...
        $ lines = [f"Don't concern yourself, {Girl.player_petname}.",
...
label maybe_later_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"I'll give it some thought, {Girl.player_petname}.",
            ...
            ". . .{p}I guess?",
            "We'll have to see.",
            f"I might get hungry, {Girl.player_petname}.",
        ...
        $ lines = [f"I will give it some thought, {Girl.player_petname}.",
            ". . .{p}Perhaps. . .",
            "Perhaps.",
...
label begging_lines(Girl, Action_type):
    if Girl == RogueX:
        ...
        $ lines = [f"Well{Girl.like}if you ask nicely. . .",
...
label action_already_rejected_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"Learn to take \"no\" for an answer, {Girl.player_petname}.",
        ...
        $ lines = [f"Look, I already told you no thanks, {Girl.player_petname}.",
...
label otherwise_not_interested_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = ["Nah, I don't think I'm interested.",
            ...
            f"I don't think we need any toys, {Girl.player_petname}."]
    elif Girl == KittyX:
        $ lines = ["Um, no.",
            f"Um, no thanks, {Girl.player_petname}.",
            "Oh, um, no, I'm not really comfortable with that. . .",
        ...
        $ lines = ["You wish.",
            ...
            f"Perhaps later, {Girl.player_petname}.",
            f"We don't need any toys, do we, {Girl.player_petname}?",
            f"I don't think we need any toys, {Girl.player_petname}.",
            f"Not now, {Girl.player_petname}. . .",
...
label previous_action_rejected_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"Sorry, {Girl.player_petname} you aren't touching these again.",
            f"Sorry, {Girl.player_petname} you aren't getting these in your mouth.",
        ...
        $ lines = ["You had your shot.",
            ...
            "Sorry, you can keep your toys out of there.",
            "I'm not feeling it today. . .",
            f"Maybe just{Girl.like}fuck yourself, huh?",
            f"That's{Girl.like}totally off the table.",
            "Yeah, not again."]
    elif Girl == EmmaX:
...
label forced_but_not_unwelcome_lines(Girl, Action_type):
    if Girl == RogueX:
        ...
        $ lines = ["That is not appropriate. . .",
            ...
            "Well hello there. . .",
            "Suit yourself.",
            f"Hm. Alright, but don't push your luck, {Girl.player_petname}.",
            "Oh, fine. . .",
            "Ok, fine. If we're going to do this, stick it in already.",
            "Oh, very well.",
...
label said_no_recently_lines(Girl, Action_type):
    if Girl == RogueX:
        ...
        $ lines = [f"{Girl.Like}no way, {Girl.player_petname}.",
        ...
        $ lines = [f"Your persistence is doing you no favors, {Girl.player_petname}.",
        ...
        $ lines = [f"Do not persist in this, {Girl.player_petname}.",
...
label action_accepted_enthusiastically_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"Ok {Girl.player_petname} come and get'em.",
            f"Ok {Girl.player_petname} go ahead.",
            "Oooooooh. . .",
            "God yes.",
            "Sure, grab a cheek.",
            "Sure, get in there."]
...
label said_no_today_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"I already told you \"no,\" {Girl.player_petname}.",
        ...
        $ lines = [f"I{Girl.like}already told you \"no\"."
...
label forced_action_rejected_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = ["I don't want you touching me.",
            ...
            f"Not even, {Girl.player_petname}.",
            "Not even that much.",
            f"Stay out of my pants, {Girl.player_petname}.",
            "Hands off the booty!",
            "Ew, no way.",
        ...
        $ lines = ["Not even.",
            f"{Girl.Like}get your mouth away from me.",
            f"Keep away from my kitty, {Girl.player_petname}.",
            "Back off!",
            "Um, no way.",
            "Ew, no way.",
...
label try_something_else_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"I know you're having fun, but maybe we could try something else {Girl.player_petname}.",
...
label satisfied_lines(Girl, Action_type):
    if Girl == RogueX:
        ...
        $ lines = [f"I hope there was{Girl.like}enough to work with.",
...
label get_out_lines(Girl):
    ...
    if Girl in [RogueX, KittyX, EmmaX, LauraX, JeanX, JubesX]:
        $ lines = [f"{Girl.name} pushes you back into the hall and slams the door. You head back to your room.",
            f"{Girl.name} shoves you back into the hall and slams the door. You head back to your room."]
    elif Girl == StormX:
        $ lines = [f"{Girl.name} pushes you to the top of the stairs and slams the door. You head back to your room."]
    "[line]"
...
label unconvinced_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"Tsk, not this time, {Girl.player_petname} that just seems. . . dirty.",
            "I really don't think that I would."]
    elif Girl == KittyX:
        $ lines = [f"Um, not this time, {Girl.player_petname}, that's too. . .",
            "I really don't think so.",
            "I really don't think that I would."]
    elif Girl == EmmaX:
        $ lines = [f"I would, but still no, {Girl.player_petname}.",
            "I really don't think so.",
...
label starting_to_get_bored_lines(Girl, Action_type):
    if Girl == RogueX:
        ...
        $ lines = ["You're just going at them, huh?",
            ...
            "What are you even?",
            "Are you getting close here? I'm getting a little sore.",
            f"So are we{Girl.like}getting close here?",
            "Are you getting close here?",
            "What are you even doing down there?",
            f"So are we{Girl.like}getting close here? This is not super pleasant. . ."]
    elif Girl == EmmaX:
...
label definitely_bored_now_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"I'm getting rug-burn here {Girl.player_petname}. Can we do something else?",
        ...
        $ lines = [f"Maybe we could try something else here {Girl.player_petname}?",
        ...
        $ lines = [f"Perhaps we could try something else, {Girl.player_petname}?",
        ...
        $ lines = [f"Maybe it's time for something else, {Girl.player_petname}?",
...
label since_you_are_so_nice_lines(Girl, Action_type):
    if Girl == RogueX:
        ...
        $ lines = ["{i}Well. . .{/i} I didn't say I didn't want to. . .",
            f"Well{Girl.like}just take it easy, ok? . .",
            "I guess it doesn't feel so bad. . .",
...
label auto_accepted_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"Ok, {Girl.player_petname}, let's do this.",
            "Hmm, stick it in. . .",
            "Hmm, I've apparently got someone's attention. . ."]
    elif Girl == KittyX:
        $ lines = [f"Oh. . . game on, {Girl.player_petname}.",
            f"Ooo, {Girl.player_petname}, toys!",
            "Hmm, stick it in. . .",
            "Oookay. . .",
            "Hmm, I've apparently got someone's attention. . ."]
    elif Girl == EmmaX:
        $ lines = [f"Mmm, if you insist, {Girl.player_petname}.",
            f"Hmm, {Girl.player_petname}, toys!",
            f"Mmmm, {Girl.player_petname}, toys. . .",
            "Oooh, naughty boy. . .",
        ...
        $ lines = [f"Oh, if you must, {Girl.player_petname}.",
            f"Ooo, {Girl.player_petname}, toys!",
            "Oh! Sure. . .",
            "Oh, what did you have in mind with that? . ."]
    elif Girl == StormX:
...
label were_done_here_lines(Girl, Action_type):
    $ lines = [f"{Girl.name} shoves you away and slaps you in the face.",
...
label first_action_approval_mostly_devotion_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"If that's what you want, {Girl.player_petname}. . .",
        ...
        $ lines = ["That is what you want?",
            ...
            f"If you enjoy watching, {Girl.player_petname}. . .",
...
label anal_insertion_not_loose_done_today_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"Sorry, I just need a little break back there, {Girl.player_petname}.",
...
label first_time_asking_lines(Girl, Action_type):
    if Girl == RogueX:
        ...
        $ lines = [f"Hmm, are you sure you can handle that, {Girl.player_petname}?",
...
label achievement_lines(Girl, Action_type):
    if Girl == RogueX:
        ...
        if Action_type == "handjob":
            $ lines.append(f"I've kinda become{Girl.like}a \"Handi-Queen\" or something.")
        elif Action_type == "footjob":
            $ lines.append("I guess I've gotten pretty smooth at the \"Kittypedi\".")
        elif Action_type == "blowjob":
            $ lines.append(f"I can't{Girl.like}get your taste out of my mind.")
    elif Girl == EmmaX:
        ...
        if Action_type == "handjob":
            ...
            $ lines.append(f"You taste positively intoxicating, {Girl.player_petname}.")
        elif Action_type == "titjob":
            $ lines.append("They've been trained well over the years.")
    elif Girl == LauraX:
        $ lines = [f"Looks like you filled out the punch card, {Girl.player_petname}.",
        ...
        if Action_type == "handjob":
            ...
            $ lines.append(f"I cannot imagine how I went this long without such a delicacy, {Girl.player_petname}.")
...
label lend_some_helping_hands_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"Well, {Girl.player_petname}, I suppose I could use some help with these. . .",
            f"Well, {Girl.player_petname}, I suppose you could help me with these. . ."]
    elif Girl == KittyX:
        $ lines = ["Um, you know, maybe start up top?",
            f"I'd{Girl.like}love it if you could give me a hand. . ."]
    elif Girl == EmmaX:
...
label well_in_hand_desire_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"Well, {Girl.player_petname}, I suppose I do at that . ."]
    elif Girl == KittyX:
...
label what_did_you_come_over_for_approval_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"So what did you come over for anyway, {Girl.player_petname}?"]
    elif Girl == KittyX:
        $ lines = [f"So what are you{Girl.like}even doing here?"]
    elif Girl == EmmaX:
...
label fancy_bumping_into_you_approval_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"So . . . fancy bumping into you here, {Girl.player_petname}. . ."]
    elif Girl == KittyX:
        $ lines = [f"I{Girl.like}didn't expect to see you here. . ."]
    elif Girl == EmmaX:
...
label masturbation_join_in_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"Yeah, did you want something, {Girl.player_petname}?"]
    elif Girl == KittyX:
...
label masturbation_worn_out_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"I need to take a little break here, {Girl.player_petname}.",
...
label end_of_masturbation_satisfied_lines(Girl, Action_type):
    if Girl == RogueX:
        $ lines = [f"That really worked for me, {Girl.player_petname}. How about you?"]
    elif Girl == KittyX:
