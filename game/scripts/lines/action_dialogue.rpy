...
label Action_forcefully_approved_lines(Girl, Action_type):
    if Girl.tag == "Rogue":
        ...
        if Action_type in ["footjob", "blowjob", "handjob", "titjob"]:
        ...
        if Action_type in ["footjob", "hotdog"]:
            $ lines.append("Odd. . .")
    elif Girl.tag == "Storm":
        $ lines = [
            "Tsk, again?",
...
label forced_but_not_unwelcome_lines(Girl, Action_type):
    if Girl.tag == "Rogue":
        ...
        if Action_type in insertion_Action_types:
            $ lines.append("Ok, get in there if you're so determined.")
            $ lines.append("Ok, fine. If we're going to do this, stick it in already.")

        if Action_type in cock_Action_types:
            $ lines.append("Ok, fine, whip it out.")

        if Action_type in passive_Action_types:
            $ lines.append("Ok, fine. I'll give it a try.")

        if Action_type in hand_Action_types or Action_type in mouth_Action_types:
            $ lines.append("Well, at least make it worth it.")
    elif Girl.tag == "Kitty":
        $ lines = [
            "Rude! But. . . whatever.",
            "Hmmph.",
        ...
        if Action_type in insertion_Action_types:
            $ lines.append("Ok, get in there if you're so determined.")
            $ lines.append("Ok, fine. If we're going to do this, stick it in already.")
            $ lines.append("Well! . . ok, fine, stick it in.")

        if Action_type in cock_Action_types:
            $ lines.append("Ok, fine, whip it out.")

        if Action_type in hand_Action_types or Action_type in mouth_Action_types:
            $ lines.append("Ugh, I guess if you're so enthusiastic. . .")
    elif Girl.tag == "Emma":
        $ lines = [
            "Hmmph.",
            "Oh, if you insist. . .",
        ...
        if Action_type in breast_Action_types or Action_type == "titjob":
            $ lines.append("You'd better shower them with praise. . .")

        if Action_type in insertion_Action_types:
            $ lines.append("Ok, fine. If we're going to do this, stick it in already.")

        if Action_type in cock_Action_types:
            $ lines.append("Well hello there. . .")
            $ lines.append("Alright, fine. Lay back.")
            $ lines.append("Fine, if it'll shut you up.")

        if Action_type in hand_Action_types or Action_type in mouth_Action_types:
            $ lines.append("Suit yourself.")
            $ lines.append("Oh, very well, get it over with.")
            $ lines.append("That is not appropriate. . . but neither is it entirely unwelcome. . .")
    elif Girl.tag == "Laura":
        $ lines = [
            "Hey. . .",
            "Eh, whatever. . .",
        ...
        if Action_type in hand_Action_types or Action_type in mouth_Action_types:
            $ lines.append("Suit yourself.")
            $ lines.append("Oh fine, get it over with.")
    elif Girl.tag == "Jean":
        $ lines = [
            "Hey. . .{p}. . .whatever. . .",
        ...
        if Action_type in cock_Action_types:
            $ lines.append(". . .{p}Ok, fine, whip it out.")
        ...
        if Action_type in cock_Action_types:
            $ lines.append("Ok, fine, whip it out.")
            $ lines.append("Fine, if it will silence you.")
            $ lines.append("Alright, fine then. Lie back.")

        if Action_type in hand_Action_types or Action_type in mouth_Action_types:
            $ lines.append("Only if you do a good job. . .")
            $ lines.append("That is not appropriate. . . but neither is it entirely unwelcome. . .")
            $ lines.append("Oh, very well, if you must.")
    elif Girl.tag == "Jubes":
        $ lines = [
            "Hey. . .{p}Well, whatever. . .",
            "Hmm. . . ok. . .",
        ...
        if Action_type in hand_Action_types or Action_type in mouth_Action_types:
            $ lines.append("Well I don't want to get in your way. . .")
            $ lines.append("Suit yourself.")
    $ line = renpy.random.choice(lines)
