label event_template:
    ...
    menu:
        ...
        "I've got places to be.":
            ...
            call change_Girl_stat(EmmaX, "devotion", 10)
        ...
        "For such a sexy teacher? I've got some time.":
            ...
            call change_Girl_stat(EmmaX, "devotion", 5)
            ...
            call change_Girl_stat(EmmaX, "desire", 5)
            call change_Girl_stat(EmmaX, "trust", 15)
    ...
    if Player.reputation <= 200:
        ...
        call change_Girl_stat(EmmaX, "devotion", 5)
        call change_Girl_stat(EmmaX, "trust", 5)
        call change_Girl_stat(EmmaX, "desire", 5)
        $ EmmaX.change_face("sly")
    ...
    if total_SEXP >= 110 or (len(Player.Harem) >= 2 and not simulation):
        call change_Girl_stat(EmmaX, "love", 5)
        call change_Girl_stat(EmmaX, "devotion", 10)
        call change_Girl_stat(EmmaX, "trust", 10)
        call change_Girl_stat(EmmaX, "desire", 5)
        $ EmmaX.change_face("sly")
        ...
        call change_Girl_stat(EmmaX, "devotion", 5)
        call change_Girl_stat(EmmaX, "trust", 5)
        call change_Girl_stat(EmmaX, "desire", 2)
        $ EmmaX.change_face("smile")
    ...
    if Player.level >= 3:
        ...
        call change_Girl_stat(EmmaX, "love", -5)
        call change_Girl_stat(EmmaX, "desire", 1)
    ...
    menu:
        ...
        "Huh.":
            ...
            call change_Girl_stat(EmmaX, "devotion", -1)
        ...
        "So you can't see what I'm picturing right now?":
            ...
            call change_Girl_stat(EmmaX, "love", 10)
            call change_Girl_stat(EmmaX, "trust", 10)
            call change_Girl_stat(EmmaX, "desire", 15)
