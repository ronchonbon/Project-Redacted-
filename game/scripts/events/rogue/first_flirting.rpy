init python:
    ...
    def Rogue_first_flirting():
        label = "Rogue_first_flirting"
...
label Rogue_first_flirting_1C:
    ...
    menu:
        ...
        "Have you thought about finding a study group?":
            call Rogue_first_flirting_2A

    return

label Rogue_first_flirting_2A:
